    ...
    <div class="right-board">
      <el-tabs v-model="currentTab" class="center-tabs">
          ...
          <div class="field-box">
            <el-scrollbar class="right-scrollbar">
              <template v-if="currentItem">
                <el-form ref="form2" size="default" label-position="top" label-width="80px">
                ...
                <el-button type="primary" size="default" @click="deleteItem(currentItem.__ID)"
                >delete
                </el-button>
              </template>
            </el-scrollbar>
        ...
        <el-tab-pane label="form attribute" name="form">
          <div class="field-box">
            <el-scrollbar class="right-scrollbar">
              <el-form ref="form" size="default" label-position="top" label-width="80px">
