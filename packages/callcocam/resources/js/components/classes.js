...
export const dataClasses = {
    select: {
        default: {
            ...
            small: 'form-select mt-1.5 w-full rounded-lg border border-slate-300 bg-white px-2 py-1 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:bg-navy-700 dark:hover:border-navy-400 dark:focus:border-accent'
        }
    },
    status: {
        default: {
