...
class APIControllerCommand extends MakeCommad
{
    ...
    public function handle()
    {
        ...
        if (!Str::contains($modelName, "\\")) {
            $resourceName = sprintf("App\\Resources\\Make\\%sResource", $modelName);
        }
        else{
            $resourceName = Str::replace("Models", "Resources\\Make", $modelName);
        }
        ...
        $this->resorceExist($resourceName, $resourceLastName);
