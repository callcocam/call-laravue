...
module.exports = {
  content: [
    ...
    "./laravue-menus/src/**/*.{php,html,js,jsx,ts,tsx,vue}",
    "./laravue-menus/resources/**/*.{php,html,js,jsx,ts,tsx,vue}",
    "./laravue-file-manager/src/**/*.{php,html,js,jsx,ts,tsx,vue}",
    ...
    "./laravue-makes/src/**/*.{php,html,js,jsx,ts,tsx,vue}",
    "./laravue-makes/resources/**/*.{php,html,js,jsx,ts,tsx,vue}",
